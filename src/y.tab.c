...
{
       0,   147,   147,   148,   149,   151,   163,   164,   165,   166,
...
{
       0,    16,    26,    24,     2,   -10,     0,   -10,   -10,     2,
      18,    25,   -10,   -10,   -10,    27,    28,     2,    29,     2,
       2,     2,     2,   -10,   -10,    30,     2,     2,     2,     2,
       7,     7,   -10,   -10,   -10,    -6,    15,    31,    32,   -10,
     -10,   -10,   -10
};
...
{
       4,     0,     0,     3,     0,     1,     4,    12,    13,     0,
       0,     5,    11,     2,    10,    12,    13,     0,     0,     0,
       0,     0,     0,    19,    20,    10,     0,     0,     0,     0,
       8,     9,     6,     7,    18,     8,     9,     6,     7,    16,
      17,    14,    15
};
...
{
      14,    18,    21,    22,     1,     7,     8,    39,    25,     9,
      30,    31,    32,    33,    10,    21,    22,    35,    36,    37,
      38,    15,    16,    21,    22,    17,     5,     4,    40,     6,
      10,    19,    20,    21,    22,    26,    27,    28,    29,    13,
      23,    24,     0,    34,    41,    42
};

static const yytype_int8 yycheck[] =
{
       9,    10,     8,     9,     4,     3,     4,    13,    17,     7,
      19,    20,    21,    22,    12,     8,     9,    26,    27,    28,
      29,     3,     4,     8,     9,     7,     0,    11,    13,     5,
      12,     6,     7,     8,     9,     6,     7,     8,     9,     6,
      13,    13,    -1,    13,    13,    13
};
...
{
       0,     4,    15,    16,    11,     0,     5,     3,     4,     7,
      12,    17,    18,    15,    17,     3,     4,     7,    17,     6,
       7,     8,     9,    13,    13,    17,     6,     7,     8,     9,
      17,    17,    17,    17,    13,    17,    17,    17,    17,    13,
      13,    13,    13
};
...
#line 151 "ast.y" /* yacc.c:1646  */
    {
									(yyval.node)=process('=', process('\0', NULL, NULL, (char *)(yyvsp[-2].p)), (astNode *)(yyvsp[0].node), NULL);
									printf("\nPrinting Inorder\n");
									printInorder((astNode *)(yyval.node));
									printf("\n\nPrinting Preorder\n");
									printPreorder((astNode *)(yyval.node));
									printf("\n\nPrinting Postorder\n");
									printPostorder((astNode *)(yyval.node));
									printf("\n");
									cleanup((astNode *)(yyval.node));
								}
...
#line 163 "ast.y" /* yacc.c:1646  */
    {(yyval.node)=process('*',(astNode *) (yyvsp[-2].node), (astNode *)(yyvsp[0].node), NULL);}
...
#line 167 "ast.y" /* yacc.c:1646  */
    {(yyval.node)=process('-', NULL, (astNode *)(yyvsp[0].node), NULL);}
#line 1402 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 169 "ast.y" /* yacc.c:1646  */
    {(yyval.node)=process('\0', NULL, NULL, (char *)(yyvsp[0].p));}
...
#line 173 "ast.y" /* yacc.c:1646  */
    {(yyval.node)=process('*',(astNode *) (yyvsp[-3].node), (astNode *)(yyvsp[-1].node), NULL);}
...
#line 177 "ast.y" /* yacc.c:1646  */
    {(yyval.node)=process('-', NULL, (astNode *)(yyvsp[-1].node), NULL);}
#line 1444 "y.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 178 "ast.y" /* yacc.c:1646  */
    {(yyval.node)=process('\0', NULL, NULL, (char *)(yyvsp[-1].p));}
